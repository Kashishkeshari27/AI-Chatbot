...
function initializeContent(effects) {
	...
	function afterContentStartConstruct(code) {
		ok$1(code === codes$1.eof || markdownLineEnding(code), "expected eol or eof");
		if (code === codes$1.eof) {
			effects.consume(code);
			return;
		}
	...
	function paragraphInitial(code) {
		ok$1(code !== codes$1.eof && !markdownLineEnding(code), "expected anything other than a line ending or EOF");
...
function tokenizeAttention(effects, ok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.asterisk || code === codes$1.underscore, "expected asterisk or underscore");
		marker = code;
...
function tokenizeAutolink(effects, ok, nok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.lessThan, "expected `<`");
...
function tokenizeCharacterEscape(effects, ok, nok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.backslash, "expected `\\`");
...
function tokenizeCharacterReference(effects, ok, nok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.ampersand, "expected `&`");
...
function tokenizeCodeFenced(effects, ok, nok) {
	...
	*/
	function beforeSequenceOpen(code) {
		ok$1(code === codes$1.graveAccent || code === codes$1.tilde, "expected `` ` `` or `~`");
...
function tokenizeCodeText(effects, ok, nok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.graveAccent, "expected `` ` ``");
...
function tokenizeContent(effects, ok) {
	...
	*/
	function chunkStart(code) {
		ok$1(code !== codes$1.eof && !markdownLineEnding(code), "expected no eof or eol");
...
function factoryLabel(effects, ok, nok, type, markerType, stringType) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.leftSquareBracket, "expected `[`");
		effects.enter(type);
...
function tokenizeHeadingAtx(effects, ok, nok) {
	...
	*/
	function before(code) {
		ok$1(code === codes$1.numberSign, "expected `#`");
...
function tokenizeLabelEnd(effects, ok, nok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.rightSquareBracket, "expected `]`");
...
function tokenizeResource(effects, ok, nok) {
	...
	*/
	function resourceStart(code) {
		ok$1(code === codes$1.leftParenthesis, "expected left paren");
...
function tokenizeReferenceFull(effects, ok, nok) {
	...
	*/
	function referenceFull(code) {
		ok$1(code === codes$1.leftSquareBracket, "expected left bracket");
...
function tokenizeLabelStartImage(effects, ok, nok) {
	...
	*/
	function start(code) {
		ok$1(code === codes$1.exclamationMark, "expected `!`");
	...
	*/
	function after(code) {
		/* c8 ignore next 3 */
		return code === codes$1.caret && "_hiddenFootnoteSupport" in self.parser.constructs ? nok(code) : ok(code);
	}
}
//#endregion
...
function tokenizeThematicBreak(effects, ok, nok) {
	...
	*/
	function before(code) {
		ok$1(code === codes$1.asterisk || code === codes$1.dash || code === codes$1.underscore, "expected `*`, `-`, or `_`");
		marker = code;
		return atBreak(code);
	}
	/**
...
function tokenizeListStart(effects, ok, nok) {
	...
	**/
	function atMarker(code) {
		ok$1(self.containerState, "expected state");
		ok$1(code !== codes$1.eof, "eof (`null`) is not a marker");
...
function tokenizeSetextUnderline(effects, ok, nok) {
	...
	*/
	function start(code) {
		...
		/** @type {boolean | undefined} */
		let paragraph;
		ok$1(code === codes$1.dash || code === codes$1.equalsTo, "expected `=` or `-`");
...
var disable = { null: [] };
//#endregion
//#region node_modules/remark-parse/node_modules/ms/index.js
...
//#endregion
//#region node_modules/remark-parse/node_modules/debug/src/common.js
